...
set.seed(1188)
holdout_sample <- training_data_raw[sample(1:nrow(training_data_raw), 15000, replace=FALSE),]
training_data <- training_data_raw[-sample(1:nrow(training_data_raw), 15000, replace=FALSE),]
